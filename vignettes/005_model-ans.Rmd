...
ggplot(evals, aes(x = bty_avg, y = score)) +
  geom_point() +
  labs(title = "Usage of geom_point() for plotting bty_avg ~ score")
```
...
ggplot(evals, aes(x = bty_avg, y = score)) +
  geom_jitter() +
  labs(title = "Usage of geom_jitter() for plotting bty_avg ~ score")
```
...
# menggunakan facet untuk melihat komparasi dengan lebih jelas
evals %>% 
  gather_predictions(model1, model2) %>% 
  ggplot(aes(x = pred, y = score, colour = model)) +
  geom_jitter() +
