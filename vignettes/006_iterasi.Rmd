...
```{r}
daftar_berkas <- list.files("C:/Users/Students/Documents/silvialatifahp/intro/data-raw", pattern = "lelang-bandung", full.names = TRUE)
daftar_berkas
```
...
```{r}
ouput_lappy # cek jenis dari output_lapply
output_lapply <- daftar_berkas
output_lapply
```
